      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <BottomSheet height="60%">
          ...
          <BottomSheet.Content>
            ...
            <button
              className="w-full px-4 py-2 bg-primary text-white rounded mb-2"
              onClick={() => alert("새 항목 추가 버튼 클릭")}
            >
              새 항목 추가
            </button>
            <button className="w-full px-4 py-2 bg-gray-500 text-white rounded" onClick={close}>
              닫기
            </button>
          </BottomSheet.Content>
        </BottomSheet>
